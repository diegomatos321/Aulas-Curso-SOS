export default class LoadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    let loadingBar = this.add.image(
      this.GAME_WIDTH / 2 - 100,
      this.GAME_HEIGHT / 2,
      "barraDeCarregamento"
    );
    ...
    let txtLoading = this.add.text(
      this.GAME_WIDTH / 2,
      this.GAME_HEIGHT / 2 + 24,
      "Loading...:"
    );
    txtLoading.setOrigin(0.5);
    let txtLoadingPerc = this.add.text(
      this.GAME_WIDTH / 2,
      this.GAME_HEIGHT / 2,
      "0%"
    );
    ...
    this.load.spritesheet(
      "Mario Pequeno",
      "./assets/imagens/Mario-Pequeno.png",
      {
        frameWidth: 16,
        frameHeight: 16,
      }
    ...
    this.load.spritesheet(
      "Luigi Pequeno",
      "./assets/imagens/Luigi-Pequeno.png",
      {
        frameWidth: 16,
        frameHeight: 16,
      }
    ...
    this.load.spritesheet(
      "surpriseBlock",
      "./assets/imagens/surpriseBlock.png",
      {
        frameWidth: 16,
        frameHeight: 16,
      }
    ...
    this.load.tilemapTiledJSON("level1", "./assets/tilemap/world1-1.json");
    ...
    this.load.audio(
      "powerupAppearsSFX",
      "./assets/audio/smb_powerup_appears.wav"
    );
  ...
  create() {
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("surpriseBlock", {
        start: 0,
        end: 3,
      }),
      frameRate: 7,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("LittleGomba", {
        start: 0,
        end: 1,
      }),
      frameRate: 8,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("KoopaTroopa", {
        start: 0,
        end: 1,
      }),
      frameRate: 8,
    ...
    this.add
      .text(this.GAME_WIDTH / 2, this.GAME_HEIGHT / 2 + 48, "Pressione ENTER")
      .setOrigin(0.5);
  ...
  criarAnimacaoDoMario() {
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("Mario Pequeno", {
        start: 6,
        end: 7,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("Mario Grande", {
        start: 7,
        end: 9,
      }),
      frameRate: 10,
  ...
  criarAnimacaoDoLuigi() {
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("Luigi Pequeno", {
        start: 6,
        end: 7,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("Luigi Grande", {
        start: 7,
        end: 9,
      }),
      frameRate: 10,
