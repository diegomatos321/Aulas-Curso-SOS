...
let nomeJogador, jogador, sexo, raca, classe = "";
let cardClicked;
...
function Confirmar() //Executa quando o butao "confimar" for clicado
{
    ...
    jogador = new Jogador(primeiroNome, sexo, raca, classe)
    console.log(jogador)
...
{
    let isYellow = this.style.borderColor == "yellow"; //Retorna "true" se a borda for amarela e "false" se nao for
    ...
    {
        this.style.borderColor = "yellow"; //Mouse por cima
    }
}
