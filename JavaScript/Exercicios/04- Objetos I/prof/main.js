...
Livro.titulo = "Luas da Ciência";
Livro.autor = "Ricardo Juarez";
Livro.paginas = "212";
...
class Falador {
    constructor(nome, verbo) {
        this.nome = nome;
        this.verbo = verbo || "fala";
    }
    falar(texto) {
        return this.nome + " " + this.verbo + " " + "'" + texto + "'";
    }
}

class Gritador extends Falador {
    falar(texto) {
        return super.falar(texto.toUpperCase());
    }
}

responder(4, new Gritador("José das Couves", "grita").falar("Oi, meu fí"));
// → José das Couves grita "OI, MEU FÍ"
